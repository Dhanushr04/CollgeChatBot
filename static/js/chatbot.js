$(document).ready(function() {
    ...
    function showWelcomeMessage() {
        const welcomeMessage = "Hi there! 👋 I'm the College AI Assistant. I can help you with information about Jorhat Engineering College.";
    ...
    $(document).on('submit', '#user-details-form', function(e) {
        ...
        if (name && phone) {
            ...
            addMessage(`Thank you, ${name}! I'll remember you next time. How can I help you with information about College?`, false);
            showQuickReplies();
        }
    });
